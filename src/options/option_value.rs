...
impl From<OptionValue> for bool {
    fn from(value: OptionValue) -> Self {
        match value {
            ...
            _ => prism_unreachable("Error converting OptionValue to bool."),
        }
    }
}
...
impl From<OptionValue> for f64 {
    fn from(value: OptionValue) -> Self {
        match value {
            ...
            _ => prism_unreachable("Error converting OptionValue to f64."),
        }
    }
}
...
impl From<OptionValue> for Option<String> {
    fn from(value: OptionValue) -> Self {
        match value {
            ...
            _ => prism_unreachable("Error converting OptionValue to Option<String>."),
        }
    }
}
...
impl From<OptionValue> for String {
    fn from(value: OptionValue) -> Self {
        match value {
            ...
            _ => prism_unreachable("Error converting OptionValue to String."),
        }
    }
}
...
impl From<OptionValue> for usize {
    fn from(value: OptionValue) -> Self {
        match value {
            ...
            _ => prism_unreachable("Error converting OptionValue to usize."),
        }
    }
}
