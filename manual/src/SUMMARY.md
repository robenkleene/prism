...
- [Usage](./usage.md)
  ...
  - [Using Prism with tmux](./using-delta-with-tmux.md)
  - [Using Prism with GNU Screen](./using-delta-with-gnu-screen.md)
  - [Using Prism on Windows](./using-delta-on-windows.md)
  - [Mouse scrolling](./mouse-scrolling.md)
  - [Using Prism with Magit](./using-delta-with-magit.md)
...
- [Prism configs used in screenshots](./delta-configs-used-in-screenshots.md)
