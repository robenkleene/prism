The purpose of prism is to transform input received from git, diff, git blame, grep, etc to produce visually appealing output, including by syntax highlighting code.
